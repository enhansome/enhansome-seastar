...
You'll still need to install several system dependencies, but this set should reduce over time. This is receipe was contributed by [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 12,500 | 🐛 546 | 🌐 C++ | 📅 2026-08-22 which has now officially moved to a 100% Bazel build.

## Projects

*Systems and projects using Seastar*

* [Ceph](https://github.com/ceph/ceph) ⭐ 16,977 | 🐛 1,303 | 🌐 C++ | 📅 2026-08-29 - Distributed storage system for object, block, and file
  * The seastar-based storage engine is called [Crimson](https://github.com/ceph/ceph/tree/master/src/crimson) ⭐ 16,977 | 🐛 1,303 | 🌐 C++ | 📅 2026-08-29
* [Scylladb](https://github.com/scylladb/scylla) ⭐ 15,728 | 🐛 3,636 | 🌐 C++ | 📅 2026-08-29 - Replacement for Apache Cassandra and Amazon DynamoDB
* [Redpanda](https://github.com/redpanda-data/redpanda/) ⭐ 12,500 | 🐛 546 | 🌐 C++ | 📅 2026-08-22 - Replacement for Apache Kafka designed for modern hardware
...
* [Official tutorial](https://github.com/scylladb/seastar/blob/master/doc/tutorial.md) ⭐ 9,347 | 🐛 578 | 🌐 C++ | 📅 2026-08-29 - a comprehensive tutorial from the creators of Seastar
