...
You'll still need to install several system dependencies, but this set should reduce over time. This is receipe was contributed by [Redpanda](https://github.com/redpanda-data/redpanda) ⭐ 12,552 | 🐛 526 | 🌐 C++ | 📅 2026-08-22 which has now officially moved to a 100% Bazel build.

## Projects

*Systems and projects using Seastar*

* [Ceph](https://github.com/ceph/ceph) ⭐ 17,053 | 🐛 1,428 | 🌐 C++ | 📅 2026-09-18 - Distributed storage system for object, block, and file
  * The seastar-based storage engine is called [Crimson](https://github.com/ceph/ceph/tree/master/src/crimson) ⭐ 17,053 | 🐛 1,428 | 🌐 C++ | 📅 2026-09-18
* [Scylladb](https://github.com/scylladb/scylla) ⭐ 15,764 | 🐛 3,683 | 🌐 C++ | 📅 2026-09-18 - Replacement for Apache Cassandra and Amazon DynamoDB
* [Redpanda](https://github.com/redpanda-data/redpanda/) ⭐ 12,552 | 🐛 526 | 🌐 C++ | 📅 2026-08-22 - Replacement for Apache Kafka designed for modern hardware
...
* [Official tutorial](https://github.com/scylladb/seastar/blob/master/doc/tutorial.md) ⭐ 9,366 | 🐛 588 | 🌐 C++ | 📅 2026-09-15 - a comprehensive tutorial from the creators of Seastar
